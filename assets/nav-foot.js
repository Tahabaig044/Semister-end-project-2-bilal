document.querySelector("header").innerHTML += `
      <nav class="navbar py-3 navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          <a class="navbar-brand" href="#"><img class="nav-logo" src="assets/styling/images/logo.png" alt=""></a>
          <button class="navbar-toggler border-0 shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <a class="btn border-0 shadow-none" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
          ...
          <div class="collapse navbar-collapse justify-content-between" id="navbar">
            <ul class="navbar-nav me-auto ms-auto ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="add to cart.html">Cart</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="index.html#box-1">Summery</a></li>
                  <li><a class="dropdown-item" href="index.html#box-2">books</a></li>
                  <li><a class="dropdown-item" href="index.html#box-3">Noble prize </a></li>
                  <li><a class="dropdown-item" href="index.html#box-4">Biography</a></li>
                  <li><a class="dropdown-item" href="index.html#box-5">Carrier</a></li>
                  <li><a class="dropdown-item" href="journey.html">Journey</a></li>
                </ul>
              </li>
            </ul>
          <a class="SingIn me-3" href="contact.html">Contact</a>
          <button class="Feedback"><a href="feedback.html">FeedBack</a></button>
          </div>
        </div>
      </nav>
          <!-- sidebar -->
          <div class="offcanvas text-success offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
            ...
            <div class="offcanvas-body">
              <div class="collapse navbar-collapse justify-content-between" id="navbar">
              <a class="SingIn me-3" href="">SignIn</a>
...
<footer>
      ...
      <div class="row">
        <div class="col-12">
          <div class="link-wrapper">
            <div class="row gy-3 gx-sm-0 gx-md-4x gx-xl-5x">
              <div class="col-6 col-sm-auto">
                <div class="icon-wrapper d-flex align-items-center gap-2 bsb-sep bsb-sep-border pe-3 me-3 pe-md-4 me-md-4">
                  ...
                  <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-dark link-opacity-75 fs-10 text-uppercase bsb-ls-1">Support</a>
                </div>
              </div>
              <div class="col-6 col-sm-auto">
                <div class="icon-wrapper d-flex align-items-center gap-2 bsb-sep bsb-sep-border bsb-sep-d-none bsb-sep-d-sm-block pe-3 me-3 pe-md-4 me-md-4">
                  ...
                  <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-dark link-opacity-75 fs-10 text-uppercase bsb-ls-1">Updates</a>
                </div>
              </div>
              <div class="col-6 col-sm-auto">
                <div class="icon-wrapper d-flex align-items-center gap-2 bsb-sep bsb-sep-border pe-3 me-3 pe-md-4 me-md-4">
                  ...
                  <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-dark link-opacity-75 fs-10 text-uppercase bsb-ls-1">Security</a>
                </div>
              </div>
              <div class="col-6 col-sm-auto">
                <div class="icon-wrapper d-flex align-items-center gap-2">
                  ...
                  <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-dark link-opacity-75 fs-10 text-uppercase bsb-ls-1">Uptime</a>
                </div>
              </div>
            </div>
          </div>
  ...
  <section class="py-3 py-md-5 py-xl-6 py-xxl-7 bg-light border-bottom">
    <div class="container">
      <div class="row gy-3">
        <div class="col-6 col-md-3">
          <div class="link-wrapper">
            <h4 class="mb-3 fw-bold fs-6">ClickUp</h4>
        ...
        <div class="col-6 col-md-3">
          <div class="link-wrapper">
            <h4 class="mb-3 fw-bold fs-6">Features</h4>
            <ul class="m-0 list-unstyled">
              <li class="mb-1">
                <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">
                  Operations
        ...
        <div class="col-6 col-md-3">
          ...
          <div class="social-wrapper">
            ...
            <ul class="m-0 list-unstyled d-flex justify-content-start gap-2">
              <li>
                <a class="d-flex align-items-center justify-content-center p-1 bg-dark rounded link-light link-opacity-75-hover" href="#!">
  ...
  <div class="py-3 bg-white py-md-4 py-xl-5">
    <div class="container">
      <div class="row gy-3 align-items-md-center">
            ...
            <div class="col-auto">
              <a href="#!" class="link-opacity-75-hover link-dark">
                <svg width="125" height="43" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="1.004" y=".244" width="123.631" height="41.631" rx="7.685" fill="#0D1530" />
                  <rect x="1.004" y=".244" width="123.631" height="41.631" rx="7.685" stroke="#000" stroke-width=".369" />
        ...
        <div class="col-12 col-md-6 col-lg-5">
          <div class="link-wrapper">
            <ul class="m-0 list-unstyled d-flex justify-content-md-end gap-2 gap-md-3">
              <li>
                <a href="#!" class="link-secondary text-decoration-none text-uppercase bsb-ls-1 fs-9 d-flex align-items-center pe-2 pe-md-3 bsb-sep bsb-sep-border">
                  Security
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#!" class="link-secondary text-decoration-none text-uppercase bsb-ls-1 fs-9 d-flex align-items-center">
                  Settings
                </a>
              </li>
            </ul>
  ...
  <div class="py-3 py-md-4 border-top border-bottom bg-light">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="copyright-wrapper d-block mb-1 text-start text-sm-center">
            &copy; 2024. All Rights Reserved.
          </div>
          <div class="credit-wrapper d-block text-secondary fs-7 text-start text-sm-center ">
            Built by<a href="#" class="link-secondary text-decoration-none">
              Waleed, Shaheer, Murtaza</a> <span style="color: #c34b45 ;">&#9829;</span>
          </div>
        </div>
      </div>
    </div>
